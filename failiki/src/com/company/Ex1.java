...
public class Ex1 {
    ...
    public static void main(String[] args) {
        System.out.println("Программа, которая вычисляет количество символов 'r' в произвольном текстовом файле");
        while (true)
        {
    ...
    private static String Imput()
    {
        ...
        while (true)
        {
            ...
            {
                System.out.println(e + " - Что-то не так. Попробуйте ввести путь ещё раз");
                scr.next();
            }
        }
        return str;
